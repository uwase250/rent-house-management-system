...
@$d=$_POST["d"];
      ...
      if(isset($go))
    {
     ...
     <?php
                    ...
                    $sql = "select customers.fname,customers.lname,houses.house_no,customers.date_in,customers.date_out,customers.duration,payments.amount,users.username from categories,customers,payments,houses,users where
                     customers.h_id=houses.id and houses.category_id=categories.id and customers.id=payments.customerid and users.id=customers.user  and date_in='$d';";
        ...
        <td>FIRST NAME</td> <td>LAST NAME</td>  <td>HOUSE NUMBER</td> <td>DATE IN</td>
                        <td>DATE OUT</td> <td>DURATION</td> <td>AMOUNT</td><td>USER</td>
...
<?php
                      ...
                      <tr>
                        ...
                        <td><?php echo $dateout; ?></td> <td><?php echo $duration; ?></td> <td><?php echo $amount."Rwf"; ?></td><td><?php echo $traction ?></td>
